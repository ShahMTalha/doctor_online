...
from src.controllers import user_bp, doctor_bp, common_bp, patient_bp, lab_bp, ambulance_bp, store_bp, donor_bp
...
flask_app.register_blueprint(donor_bp, url_prefix='/donor')
